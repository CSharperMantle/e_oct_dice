...
/**
 *  @brief      Decode the four-byte gesture data_ and execute any callbacks.
 *  @param[in]  gesture Gesture data_ from DMP packet.
 *  @return     0 if successful.
 */
    ...
    unsigned long *timestamp, short *sensors, unsigned char *more)
{
    ...
    /* Gesture data_ is at the end of the DMP packet. Parse it and call
